...
const callbackToInternationalServer = {
    int_speed_ger: 'INT_GER',
    int_speed_sweden: 'INT_SWEDEN',
    int_speed_sp: 'INT_SPAIN',
    int_speed_ir: 'INT_IRAN',
    int_speed_it: 'INT_ITALY',
    int_speed_tur: 'INT_TURKEY',
    int_speed_usa: 'INT_USA',
    int_speed_uk: 'INT_UK'
};
...
bot.on('callback_query', async (query) => {
    ...
    if (bandwidthCountries.includes(data)) {
        ...
        const bandwidthMenu = subMenus.bandwidth_menu_int;
...
//});
root@us0806082025:~/RoyalVPN_bot# vi main1.js 
root@us0806082025:~/RoyalVPN_bot# cat main1.js 
//main
const express = require('express');
const TelegramBot = require('node-telegram-bot-api');
const insertUser = require('./db/insertUser');
...
if (regularSpeedCallbacks.includes(data)) {
    ...
    const bandwidthMenu = subMenus.bandwidth_menu; // regular menu
    return bot.editMessageText(bandwidthMenu.text, {
        chat_id: chatId,
        message_id: messageId,
        reply_markup: bandwidthMenu.reply_markup
